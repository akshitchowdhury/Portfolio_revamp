...
const Cards = () => {
  return (
    <div className="card max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
        <img className="rounded-t-lg w-full" src={c1} alt="card1" />
      </a>
      <div className="p-5">
        <a href="#">
        ...
        <p className="mb-3 text-sm md:text-base font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
